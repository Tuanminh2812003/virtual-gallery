...
import MinhTestMotion from "./../../components/MinhTestMotion/index";
                ...
                <div className="main">
                    ...
                    <Canvas shadows>
                        <Suspense fallback={null}>
                            {/* Môi trường */}
                            <ModelLoader
                                path={"/assets/floating_castle.glb"}
                            ...
                            {items.map((item) => (
                                <PictureFrame
                                    ...
                                    tourPopupOpen={
                                        tourPopupOpen &&
                                        tourIndex === items.indexOf(item)
                                    } // Show tour popup when in tour and at the current item
                                />
                            ))}
                            <Minimap
                                items={items}
